    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://x.com/madhujsays" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        >
          <Link
            href="mailto:madhuj.2004@gmail.com" // Replace with your actual email
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/Madhuj275" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://www.linkedin.com/in/madhuj-agrawal-8491b328b/" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
